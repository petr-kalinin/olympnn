...
startonn("/Город/NNOI XVI/Архив","Архив XVI Нижегородской городской олимпиады школьников по информатике");
...
<?php 
print_file("nnoi2020_problems.7z","Все исходные материалы по задачам (генераторы тестов, исходники условий, проверяющие программы, решения жюри и т.д.)");

print_file("nnoi2020_tests.7z","Сегенированные тесты");

print_file("nnoi2020_sols_all.7z","Все посылки всех участников");

print_file("nnoi2020_statements.pdf","Условия","файл pdf");

print_file("nnoi2020_results.pdf","Результаты","файл pdf");

print_file("nnoi2020_tutorials.pdf","Разборы задач","файл pdf");
