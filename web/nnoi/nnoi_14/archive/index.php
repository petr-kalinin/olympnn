...
print_file("nnoi2018_book_a5.pdf","Книжка с разбором в формате a5","файл pdf");
print_file("nnoi2018_book_2xa5.pdf","Книжка с разбором по две последовательные страницы a5 на странице a4","файл pdf");
print_file("nnoi2018_book_a4.pdf","Книжка с разбором, подготовленная для двухсторонней печати на страницах a4 и последующего брошюрования в книжку a5","файл pdf");
