...
startonn("/Город/NNOI XV/Отборочный тур","Статистика отборочного тура XV Нижегородской городской олимпиады",array("/style.css","/ije_proc.css"));
?>
<h1>Отборочный тур XV Нижегородской городской олимпиады школьников по информатике</h1>
<h2>Статистика</h2>
<?php 
if (isset($_GET["prob"])) {
