...
startonn("/Город/NNOI XV/Архив","Архив XV Нижегородской городской олимпиады школьников по информатике");
...
<?php 
print_file("nnoi2019_problems.7z","Все материалы по задачам (тесты, исходники условий, проверяющие программы, решения жюри и т.д.)");

print_file("nnoi2019_sols_all.7z","Все посылки всех участников");

print_file("nnoi2019_statements.pdf","Условия","файл pdf");

print_file("nnoi2019_results.pdf","Результаты","файл pdf");

print_file("nnoi2019_tutorials.pdf","Разборы задач","файл pdf");
