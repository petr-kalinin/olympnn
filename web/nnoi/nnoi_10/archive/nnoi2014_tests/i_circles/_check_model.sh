...
fpc -Mdelphi -FE. -Fu../../../res/testlib -Fu../../../res ../circles_model.pas  || { echo "'fpc -Mdelphi -FE. -Fu../../../res/testlib -Fu../../../res ../circles_model.pas' returned non-zero exit code!" ; exit 1; }
...
./circles_model   || { echo "Test 1: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 2: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 3: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 4: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 5: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 6: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 7: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 8: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 9: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 10: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 11: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 12: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 13: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 14: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 15: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 16: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 17: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 18: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 19: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 20: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 21: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 22: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 23: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 24: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 25: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 26: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 27: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 28: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 29: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./circles_model   || { echo "Test 30: './circles_model ' returned non-zero exit code!" >> ../_daysper.log ; }
