{
 ...
 Неверное решение: неправильно угадывает стартовый угол (работает для всех четных и возможно некоторых нечетных)
 Ожидаемые баллы: 50-70
}
{$q+,r+,s+,i+,o+}
{$APPTYPE CONSOLE}
{$ifdef fpc}
