...
fpc -Mdelphi -FE. -Fu../../../res/testlib -Fu../../../res ../powersum_model.pas  || { echo "'fpc -Mdelphi -FE. -Fu../../../res/testlib -Fu../../../res ../powersum_model.pas' returned non-zero exit code!" ; exit 1; }
...
./powersum_model   || { echo "Test 1: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 2: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 3: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 4: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 5: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 6: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 7: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 8: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 9: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 10: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 11: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 12: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 13: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 14: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 15: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 16: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 17: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 18: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 19: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_model   || { echo "Test 20: './powersum_model ' returned non-zero exit code!" >> ../_daysper.log ; }
