...
startonn("/Город/NNOI XIII/Результаты","Протокол тестирования XIII Нижегородской городской олимпиады школьников по информатике",array("/style.css","/ije_proc.css"));
?>
