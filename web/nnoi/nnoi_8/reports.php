...
startonn("/Город/NNOI VIII/Результаты","Протокол тестирования VIII Нижегородской городской олимпиады школьников по информатике",array("/style.css","/ije_proc.css"));
?>
