...
startonn("/Город/NNOI XVII/Отборочный тур","Статистика отборочного тура XVII Нижегородской  олимпиады",array("/style.css","/ije_proc.css"));
?>
<h1>Отборочный тур XVII Нижегородской городской олимпиады школьников по информатике</h1>
<h2>Статистика</h2>
<?php 
if (isset($_GET["prob"])) {
