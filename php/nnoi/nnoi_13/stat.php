...
startonn("/Город/NNOI XIII/Результаты","Статистика XIII Нижегородской городской олимпиады",array("/style.css","/ije_proc.css"));
?>
...
if (isset($_GET["prob"])) {
   ...
   if (($_GET["prob"]=='all')or isset($results["results"]["problems"][$_GET["prob"]]))
      ije_showstat("nnoi/nnoi_13/results/results.xml",$_GET["prob"]);
