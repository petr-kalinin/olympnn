...
echo =================================== 
echo Making examples for statements for  . (id lottery) 
echo =================================== 
...
check _001.in lottery.out _001.ans 
IF errorlevel 1 (
  echo Test 1: 'check _001.in lottery.out _001.ans' returned non-zero exit code!
  goto error
)
...
check _002.in lottery.out _002.ans 
IF errorlevel 1 (
  echo Test 2: 'check _002.in lottery.out _002.ans' returned non-zero exit code!
  goto error
)
