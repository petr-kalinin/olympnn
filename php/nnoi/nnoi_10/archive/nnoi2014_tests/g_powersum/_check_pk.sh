...
./powersum_pk   || { echo "Test 1: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 2: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 3: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 4: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 5: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 6: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 7: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 8: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 9: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 10: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 11: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 12: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 13: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 14: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 15: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 16: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 17: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 18: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 19: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk   || { echo "Test 20: './powersum_pk ' returned non-zero exit code!" >> ../_daysper.log ; }
