...
cp ../powersum_pk_formula.py .  || { echo "'cp ../powersum_pk_formula.py .' returned non-zero exit code!" ; exit 1; }
...
./powersum_pk_formula.py   || { echo "Test 1: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 2: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 3: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 4: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 5: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 6: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 7: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 8: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 9: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 10: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 11: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 12: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 13: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 14: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 15: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 16: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 17: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 18: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 19: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
...
./powersum_pk_formula.py   || { echo "Test 20: './powersum_pk_formula.py ' returned non-zero exit code!" >> ../_daysper.log ; }
