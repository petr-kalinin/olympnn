{
 ...
 Неверное решение: ошибка в знаке угла для нечетных n --- видимо, работать должно для четных n + для нечетных n со стартовым углом 0 или pi
 Ожидаемые баллы: около 50
}
{$q+,r+,s+,i+,o+}
{$APPTYPE CONSOLE}
{$ifdef fpc}
