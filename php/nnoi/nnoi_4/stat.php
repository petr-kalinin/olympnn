...
startonn("/Город/NNOI IV/Результаты","Статистика IV Нижегородской городской олимпиады школьников по информатике",array("/style.css","/ije_proc.css"));
?>
...
if (isset($_GET["prob"])) {
   ...
   if (($_GET["prob"]=='all')or isset($results["results"]["problems"][$_GET["prob"]]))
      ije_showstat("nnoi/nnoi_4/results/results.xml",$_GET["prob"]);
