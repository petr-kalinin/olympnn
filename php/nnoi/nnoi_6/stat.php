...
startonn("/Город/NNOI VI/Результаты","Статистика VI Нижегородской городской олимпиады школьников по информатике",array("/style.css","/ije_proc.css"));
?>
...
if (isset($_GET["prob"])) {
   ...
   if (($_GET["prob"]=='all')or isset($results["results"]["problems"][$_GET["prob"]]))
      ije_showstat("nnoi/nnoi_6/results/results.xml",$_GET["prob"]);
