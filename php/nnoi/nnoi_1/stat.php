...
startonn("/Город/NNOI I/Результаты","Статистика I Нижегородской городской олимпиады школьников по информатике",array("/style.css","/ije_proc.css"));
?>
<h1>I (восстановленная) Нижегородская городская олимпиада школьников по информатике</h1>
<h2>Статистика</h2>
<?
if (isset($_GET["prob"])) {
