...
<ul>
<li>Книга в формате A5: <?print_file("nnoi_book.pdf")?></li>
<li>Книга в формате A4 по две последовательные страницы A5 на страницу A4: <?print_file("nnoi_book_double.pdf")?></li>
<li>Книга в формате A4 по две страницы A5 на страницу A4, скомпонованная для печати как брошюры (см. ниже): <?print_file("nnoi_book_print.pdf")?></li>
<li>Исходный код книги в формате LaTeX (см. ниже): <?print_file("nnoi_book_tex.zip","архив zip")?></li>
</ul>
